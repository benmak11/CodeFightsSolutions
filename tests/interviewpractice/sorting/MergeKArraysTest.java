...
public class MergeKArraysTest {
    ...
    private int[][] inputArray3 = {
            {67,83}, {1,1,5,7,9}, {-5,-2,0,1,5}, {0,0,1,5,6}, {1,1,5,7,9}, {23,34}
    };
    private int[] sortedThree = {-5, -2, 0, 0, 0, 1, 1, 1, 1, 1, 1, 5, 5, 5, 5, 6, 7, 7, 9, 9, 23, 34, 67, 83};
    ...
    public void testMergeKArraysOne() {
        ...
        for (Integer i : result) {
            Assert.assertEquals((Integer) sortedOne[count], i);
            count++;
        }
    }
    ...
    public void testMergeKArraysTwo() {
        ...
        for (Integer i : result) {
            Assert.assertEquals((Integer) sortedTwo[count], i);
            count++;
        }
    ...
    public void testMergeKArraysThree() {
        ...
        for (Integer i : result) {
            Assert.assertEquals((Integer) sortedThree[count], i);
            count++;
        }
    }
}